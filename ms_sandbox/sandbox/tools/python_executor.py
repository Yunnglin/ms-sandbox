...
from ..model import ExecutionStatus, ToolExecutionResult, SandboxType
...
class PythonExecutor(SandboxTool):
    ...
    async def execute(self, sandbox_context: 'DockerSandbox', code: str, timeout: Optional[int] = 30) -> ToolExecutionResult:
