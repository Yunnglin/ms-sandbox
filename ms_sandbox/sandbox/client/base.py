...
class BaseSandboxClient(abc.ABC):
    ...
    async def execute_code_current(self, code: str, language: str = 'python', **kwargs) -> Dict[str, Any]:
    ...
    async def write_file_current(self, path: str, content: Union[str, bytes], **kwargs) -> Dict[str, Any]:
